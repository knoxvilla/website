...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Male Next Finch</title>
        <meta property="og:title" content="Male Next Finch" />
      </Helmet>
      <header data-role="Accordion" className="home-header">
        <a
          href="https://ramseyknox.com"
          target="_blank"
        ...
        >
          <img
            alt="logo"
            src="https://i.imgur.com/UTeVyvq.png"
      ...
      <div className="home-hero">
        <img
          alt="image"
          src="https://i.imgur.com/cPryux6.png"
          className="home-image1"
        />
        <a
          href="https://linktr.ee/ramseyknox"
          target="_blank"
          rel="noreferrer noopener"
        ...
        >
          <img
            alt="image"
            src="https://i.imgur.com/y3V52ru.jpg"
      ...
      <footer className="home-footer">
        ...
        <span className="home-text">
          <span>Ramsey Knox. </span>
          <span>Omega Theory. </span>
          <span>Ponderosa.</span>
        </span>
        <div className="home-icon-group">
          <a
            href="https://twitter.com/ramseyknoxx"
            target="_blank"
            rel="noreferrer noopener"
          ...
          <a
            href="https://instagram.com/rehmsin"
            target="_blank"
            rel="noreferrer noopener"
          ...
          <a
            href="https://who the fuck uses facebook bro"
            target="_blank"
            rel="noreferrer noopener"
